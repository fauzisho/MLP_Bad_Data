...
if __name__ == "__main__":
    ...
    model_path = 'augmented_images_path.h5'  # Path to trained model
    ...
    all_sliding_window_patches = 'dataset/all_sliding_window_patches'  # Folder containing test images
    ...
    test_folder_and_analyze(all_sliding_window_patches, detector)
